...
namespace Cysharp.Threading.Tasks
{
	...
	class TextSelectionEventConverter : UnityEvent<(string, int, int)>, IDisposable
	{
	...
	public class AsyncUnityEventHandler<T> : IUniTaskSource<T>, IDisposable, IAsyncValueChangedEventHandler<T>, IAsyncEndEditEventHandler<T>
		, IAsyncEndTextSelectionEventHandler<T>, IAsyncTextSelectionEventHandler<T>, IAsyncDeselectEventHandler<T>, IAsyncSelectEventHandler<T>,
