...
namespace Cysharp.Threading.Tasks.Linq
{
	public static partial class UniTaskAsyncEnumerable
	{
		...
		public static UniTask<ILookup<TKey, TElement>> ToLookupAsync<TSource, TKey, TElement>(this IUniTaskAsyncEnumerable<TSource> source,
		...
		public static UniTask<ILookup<TKey, TSource>> ToLookupAwaitAsync<TSource, TKey>(this IUniTaskAsyncEnumerable<TSource> source,
	...
	static class ToLookup
	{
		...
		internal static async UniTask<ILookup<TKey, TElement>> ToLookupAsync<TSource, TKey, TElement>(IUniTaskAsyncEnumerable<TSource> source,
		...
		internal static async UniTask<ILookup<TKey, TSource>> ToLookupAwaitAsync<TSource, TKey>(IUniTaskAsyncEnumerable<TSource> source,
		...
		class Lookup<TKey, TElement> : ILookup<TKey, TElement>
		{
			...
			{
				get { return dict.TryGetValue(key, out Grouping<TKey, TElement> g) ? g : Enumerable.Empty<TElement>(); }
			}
