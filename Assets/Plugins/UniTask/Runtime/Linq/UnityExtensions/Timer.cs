...
namespace Cysharp.Threading.Tasks.Linq
{
	public static partial class UniTaskAsyncEnumerable
	{
		...
		public static IUniTaskAsyncEnumerable<AsyncUnit> Timer(TimeSpan dueTime, TimeSpan period, PlayerLoopTiming updateTiming = PlayerLoopTiming.Update,
			bool ignoreTimeScale = false, bool cancelImmediately = false)
		{
	...
	class Timer : IUniTaskAsyncEnumerable<AsyncUnit>
	{
	...
	class TimerFrame : IUniTaskAsyncEnumerable<AsyncUnit>
	{
		readonly PlayerLoopTiming updateTiming;
