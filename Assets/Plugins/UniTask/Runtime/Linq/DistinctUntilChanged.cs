...
namespace Cysharp.Threading.Tasks.Linq
{
	...
	sealed class DistinctUntilChanged<TSource> : IUniTaskAsyncEnumerable<TSource>
	{
	...
	sealed class DistinctUntilChanged<TSource, TKey> : IUniTaskAsyncEnumerable<TSource>
	{
		readonly IUniTaskAsyncEnumerable<TSource> source;
	...
	sealed class DistinctUntilChangedAwait<TSource, TKey> : IUniTaskAsyncEnumerable<TSource>
	{
		readonly IUniTaskAsyncEnumerable<TSource> source;
	...
	sealed class DistinctUntilChangedAwaitWithCancellation<TSource, TKey> : IUniTaskAsyncEnumerable<TSource>
	{
		readonly IUniTaskAsyncEnumerable<TSource> source;
