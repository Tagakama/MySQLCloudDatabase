	...
	public static partial class UnityAsyncExtensions
	{
			...
			CancellationToken cancellationToken = default, bool cancelImmediately = false)
		{
			...
			return new UniTask<AsyncGPUReadbackRequest>(
				AsyncGPUReadbackRequestAwaiterConfiguredSource.Create(asyncOperation, timing, cancellationToken, cancelImmediately, out short token), token);
		}
			...
			ITaskPoolNode<AsyncGPUReadbackRequestAwaiterConfiguredSource>
		{
			...
			public static IUniTaskSource<AsyncGPUReadbackRequest> Create(AsyncGPUReadbackRequest asyncOperation, PlayerLoopTiming timing,
