...
namespace Cysharp.Threading.Tasks
{
	public static class CancellationTokenExtensions
	{
		...
		public static CancellationTokenRegistration RegisterWithoutCaptureExecutionContext(this CancellationToken cancellationToken, Action<object> callback,
			object state)
		{
			bool restoreFlow = false;
			if (!ExecutionContext.IsFlowSuppressed())
	...
	public struct CancellationTokenAwaitable
	{
		...
		public struct Awaiter : ICriticalNotifyCompletion
		{
			...
			{
				get { return !cancellationToken.CanBeCanceled || cancellationToken.IsCancellationRequested; }
			}
